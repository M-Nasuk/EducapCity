      ...
      <ul class="slides">
        ...
        <li>
          <div class="link_edi19">
            ...
            <a href="Edition 2019" class="bg-red-op">Découvrez l'édition 2019<i class="fas fa-chevron-circle-right"></i></a>
          </div>
        </li>
        <li>
          <div class="link_inscri">
            ...
            <a href="Inscription" class="pre bg-red-op">Etape Capitale - Jeudi 20 juin 2019
              Les inscriptions sont ouvertes<i class="fas fa-chevron-circle-right"></i></a>
          </div>
        </li>
      </ul>
    </div>
